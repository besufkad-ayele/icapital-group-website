...
export const metadata: Metadata = {
  title: "Photo Gallery | East Africa Finance Summit",
  description: "Photos from East Africa Finance Summit events.",
};
    ...
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <div className="container mx-auto px-6 py-24 text-center md:px-12">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
          Event photos and highlights will be published here after each summit.
        </p>
        <Link
