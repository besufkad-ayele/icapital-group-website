...
interface PlatiniumSponsorsProps {
  platiniumSponsors: {
    heading?: string;
    logosCard?: {
      companyName?: string;
...
const PlatiniumSponsors = ({ platiniumSponsors }: PlatiniumSponsorsProps) => (
  <section className="bg-[#FAFAFA] py-16 md:py-24">
    <div className="container mx-auto px-6 md:px-12 lg:px-24">
      <h2 className="mb-12 text-center text-2xl font-bold text-[#253E5E] md:text-3xl">
        {platiniumSponsors?.heading }
      </h2>
      <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
        {platiniumSponsors?.logosCard?.map((logo, i) => (
          <div
...
export default PlatiniumSponsors;
